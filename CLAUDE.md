...
docker build -t amc .  # Build production image
```
...
```python
from amc.utils.logging import setup_logging, get_logger
...
```python
from amc.middleware.correlation import (
    set_correlation_id,
...
git worktree add ../amc-worktrees/feature-name -b feature/feature-name
git worktree add ../amc-worktrees/pr-42 origin/feature/pr-branch
git worktree list
git worktree remove ../amc-worktrees/feature-name
```
