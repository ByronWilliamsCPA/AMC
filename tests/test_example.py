"""Example tests demonstrating best practices for AMC.
...
class TestPackageInitialization:
    ...
    def test_package_author_exists(self) -> None:
        ...
        """
        from amc import __author__, __email__
...
class TestLogging:
    ...
    def test_log_performance(self) -> None:
        ...
        from amc.utils.logging import log_performance
...
class TestCLI:
    ...
    def test_cli_config_command(self) -> None:
        ...
        assert "Project: AMC" in result.output
    ...
    def test_cli_hello_error_handling(self) -> None:
        ...
        with patch("amc.cli.logger") as mock_logger:
...
class TestExampleIntegration:
    ...
    def test_package_imports(self) -> None:
        ...
        assert hasattr(amc, "__version__")

        # Test importing from submodules
        from amc.utils import get_logger

        assert callable(get_logger)

        from amc.core import Settings
