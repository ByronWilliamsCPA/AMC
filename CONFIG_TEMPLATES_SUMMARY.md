...
All configuration files have been created in `/home/user/cookiecutter-python-template/amc/`

### 1. **codecov.yml** - Code Coverage Configuration
- **Purpose**: Configure Codecov for coverage tracking and reporting
- **Cookiecutter Variables**:
  - `AMC` - Project name in comments
  - `Web app for practice math tests` - Description in comments
  - `amc` - Module path for coverage tracking
...
- **Cookiecutter Variables**:
  ...
  - `https://github.com/williaby/AMC` - Download location
...
- **Cookiecutter Variables**:
  - `AMC` - Site name and title
  - `Web app for practice math tests` - Site description
  - `Byron Williams` - Author and copyright holder
  - `https://AMC.readthedocs.io` - Documentation site URL
  - `https://github.com/williaby/AMC` - Repository URL
  - `williaby` - GitHub org/user in repo name
  - `amc` - Project slug for repo name
- **Features**:
...
|----------|------|---------|---------|
| `AMC` | string | "My Python Project" | codecov.yml, mkdocs.yml |
| `amc` | auto | Derived from project_name | codecov.yml, renovate.json, REUSE.toml, mkdocs.yml, noxfile.py |
| `Web app for practice math tests` | string | "A short description..." | codecov.yml, mkdocs.yml |
...
| `https://github.com/williaby/AMC` | auto | Derived from github info | REUSE.toml, mkdocs.yml |
| `https://AMC.readthedocs.io` | auto | Derived from project_slug | mkdocs.yml |
...
- **ingestion**: PDF/Image Ingestion module (`src/amc/ingestion/**`)
- **detection**: IQA Detection module (`src/amc/detection/**`)
- **correction**: Image Correction module (`src/amc/correction/**`)
- **output**: JSON Output module (`src/amc/output/**`)
- **utils**: Utilities module (`src/amc/utils/**`)
