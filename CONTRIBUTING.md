...
Thank you for your interest in contributing to AMC! This document provides guidelines and instructions for contributing to the project.
...
uv run pytest --cov=amc --cov-report=term-missing
```
...
uv run pytest --cov=amc --cov-report=html
...
import pytest
from pathlib import Path
from amc.core import YourModule
...
Thank you for contributing to AMC!
